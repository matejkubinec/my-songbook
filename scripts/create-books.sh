...
chordpro "--cover=songbooks/covers/30+30+01.pdf" "--filelist=songbooks/30+30+01.list" "--output=books/30+30+01/30+30+01.bass.pdf" "--decapo" "--config=./config/settings.json"
...
chordpro "--cover=songbooks/covers/masterbook.pdf" songs/**/*.cho "--output=books/masterbook/masterbook.bass.pdf" "--decapo" "--config=./config/settings.json"
